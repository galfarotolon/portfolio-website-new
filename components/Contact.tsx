...
const ContactForm: React.FC = () => {
  ...
  const onSubmit = async (data: FormData) => {
    // Reset the success and error states before submitting the form
    setSuccess(false);
    setError(false);
  ...
  // Clear the success message if there are validation errors
  useEffect(() => {
  ...
  return (
    <section id="contact" className="py-20">
      ...
      >
        ...
        <div className="formContainer flex-1 relative w-full">
          <motion.div
            className="phoneSvg"
            initial={{ opacity: 1 }}
